...
public class Demostrador2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TimeUnit.SECONDS.sleep(2);
		System.out.println(
				"\nVamos a hacer logout de " + usuario.getUsuario().getNombre() + ", registrar otro que sea mayor de edad y comprobar que el si que puede encontrarla y, ademas, reproducirla\n");

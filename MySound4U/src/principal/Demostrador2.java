...
public class Demostrador2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Se va a reproducir la cancion");
		...
		System.out.println(
				"\nVamos a hacer logout de este usuario y registrar otro que sea mayor de edad y comprobar que el si que puede encontrarla y, ademas, reproducirla");
		...
		System.out.println("Se va a reproducir la cancion explicita \"RookiezisPunk\"");
		TimeUnit.SECONDS.sleep(2);
		usuario.reproducir(canciones.get(1));
		TimeUnit.SECONDS.sleep(2);
		System.out.println("Se va a parar la cancion en 10 segundos");

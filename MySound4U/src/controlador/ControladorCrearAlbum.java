...
public class ControladorCrearAlbum implements ActionListener {
	...
	public ControladorCrearAlbum(VistaCrearAlbum crear, SesionUsuarios sesion, VistaRegistrado vista, Aplicacion api) {
		super();
		this.crear = crear;
		this.sesion = sesion;
		this.vista = vista;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (nombre.isEmpty() && component == crear.getBtn1())
			...
			ControladorAddToAlbum controlA = new ControladorAddToAlbum(vista2, api, albumes.get(albumes.size() - 1));
